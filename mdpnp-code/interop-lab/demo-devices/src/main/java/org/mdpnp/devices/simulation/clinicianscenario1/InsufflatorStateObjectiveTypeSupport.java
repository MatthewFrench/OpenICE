...
public class InsufflatorStateObjectiveTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::InsufflatorStateObjective";
    ...
    private static final InsufflatorStateObjectiveTypeSupport _singleton
        = new InsufflatorStateObjectiveTypeSupport();
     ...
     */
    public static InsufflatorStateObjectiveTypeSupport get_instance() {
        return _singleton;
    }

    public static InsufflatorStateObjectiveTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return InsufflatorStateObjective.create();
    }
    ...
    public Object create_key() {
        return new InsufflatorStateObjective();
    }
    ...
    public Class get_type() {
        return InsufflatorStateObjective.class;
    }
     ...
     * <code>this</code> is not a <code>InsufflatorStateObjective</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
    	InsufflatorStateObjective typedDst = (InsufflatorStateObjective) destination;
    	InsufflatorStateObjective typedSrc = (InsufflatorStateObjective) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        InsufflatorStateObjective typedSrc = (InsufflatorStateObjective) sample;
...
InsufflatorStateObjective typedDst = (InsufflatorStateObjective) dst;
...
InsufflatorStateObjective typedDst = (InsufflatorStateObjective) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
InsufflatorStateObjective typedDst = (InsufflatorStateObjective) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        InsufflatorStateObjective typedDst
            = (InsufflatorStateObjective) instance;
        InsufflatorStateObjective typedSrc
            = (InsufflatorStateObjective) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new InsufflatorStateDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new InsufflatorStateDataReader(native_reader, listener, mask, this);                
    ...
    protected InsufflatorStateObjectiveTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,InsufflatorStateObjectiveTypeCode.VALUE,InsufflatorStateObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected InsufflatorStateObjectiveTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,InsufflatorStateObjectiveTypeCode.VALUE,InsufflatorStateObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
