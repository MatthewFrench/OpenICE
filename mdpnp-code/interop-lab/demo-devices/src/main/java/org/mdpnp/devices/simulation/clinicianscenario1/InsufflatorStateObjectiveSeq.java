 ...
 */
public final class InsufflatorStateObjectiveSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public InsufflatorStateObjectiveSeq() {
        super(InsufflatorStateObjective.class);
    }


    public InsufflatorStateObjectiveSeq(int initialMaximum) {
        super(InsufflatorStateObjective.class, initialMaximum);
    }


    public InsufflatorStateObjectiveSeq(Collection elements) {
        super(InsufflatorStateObjective.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    set(i, InsufflatorStateObjective.create());
                }
        ...
        for(int i = origSize; i < srcSize; i++){
            if (typedSrc.get(i) == null) {
                ...
                add(InsufflatorStateObjective.create());
