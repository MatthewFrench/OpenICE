...
public class HeartRateIncreaseObjectiveTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::HeartRateIncreaseObjective";
    ...
    private static final HeartRateIncreaseObjectiveTypeSupport _singleton
        = new HeartRateIncreaseObjectiveTypeSupport();
     ...
     */
    public static HeartRateIncreaseObjectiveTypeSupport get_instance() {
        return _singleton;
    }

    public static HeartRateIncreaseObjectiveTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return HeartRateIncreaseObjective.create();
    }
    ...
    public Object create_key() {
        return new HeartRateIncreaseObjective();
    }
    ...
    public Class get_type() {
        return HeartRateIncreaseObjective.class;
    }
     ...
     * <code>this</code> is not a <code>HeartRateIncreaseObjective</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        HeartRateIncreaseObjective typedDst = (HeartRateIncreaseObjective) destination;
        HeartRateIncreaseObjective typedSrc = (HeartRateIncreaseObjective) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        HeartRateIncreaseObjective typedSrc = (HeartRateIncreaseObjective) sample;
...
HeartRateIncreaseObjective typedSrc = (HeartRateIncreaseObjective) src;    
        ...
        dst.writeFloat(typedSrc.lower);        
            
        dst.writeFloat(typedSrc.upper);        
...
HeartRateIncreaseObjective typedDst = (HeartRateIncreaseObjective) dst;
    ...
    try {
            ...
            typedDst.lower = src.readFloat();
            
            typedDst.upper = src.readFloat();
...
HeartRateIncreaseObjective typedDst = (HeartRateIncreaseObjective) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
HeartRateIncreaseObjective typedDst = (HeartRateIncreaseObjective) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        HeartRateIncreaseObjective typedDst
            = (HeartRateIncreaseObjective) instance;
        HeartRateIncreaseObjective typedSrc
            = (HeartRateIncreaseObjective) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new HeartRateIncreaseDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new HeartRateIncreaseDataReader(native_reader, listener, mask, this);                
    ...
    protected HeartRateIncreaseObjectiveTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,HeartRateIncreaseObjectiveTypeCode.VALUE,HeartRateIncreaseObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected HeartRateIncreaseObjectiveTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,HeartRateIncreaseObjectiveTypeCode.VALUE,HeartRateIncreaseObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
