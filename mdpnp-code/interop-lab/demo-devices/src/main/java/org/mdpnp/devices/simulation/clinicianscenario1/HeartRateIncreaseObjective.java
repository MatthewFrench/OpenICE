...
public class HeartRateIncreaseObjective implements Copyable, Serializable
{
    ...
    public HeartRateIncreaseObjective() {

    }


    public HeartRateIncreaseObjective(HeartRateIncreaseObjective other) {
    ...
    public static Object create() {
    	HeartRateIncreaseObjective self;
        self = new HeartRateIncreaseObjective();
    ...
    public boolean equals(Object o) {
        ...
        HeartRateIncreaseObjective otherObj = (HeartRateIncreaseObjective)o;
    ...
    public Object copy_from(Object src) {
    	...
    	HeartRateIncreaseObjective typedSrc = (HeartRateIncreaseObjective) src;
    	HeartRateIncreaseObjective typedDst = this;
